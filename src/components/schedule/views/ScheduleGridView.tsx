...
export const ScheduleGridView = React.memo(function ScheduleGridView({
  ...
  const rowVirtualizer = useVirtualizer({
    ...
    estimateSize: React.useCallback(() => (showOffBalance ? 70 : 62), [showOffBalance]),
    overscan: 8,
  });
    ...
    <div className="bg-white dark:bg-gray-900 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700">
      ...
      >
        <div className="min-w-max">
          <div
            className="grid border-b border-gray-200 dark:border-gray-700 sticky top-0 z-10 bg-white dark:bg-gray-900"
          ...
          {displayMembers.length === 0 ? (
            ...
            <div className="relative" style={{ height: rowVirtualizer.getTotalSize() }}>
              {rowVirtualizer.getVirtualItems().map((virtualRow) => {
                const member = displayMembers[virtualRow.index];
                ...
                return (
                  <div
                    ...
                    className="grid border-b border-gray-100 dark:border-gray-800 hover:bg-gray-50 dark:hover:bg-gray-800/50 absolute left-0 right-0"
                    style={{
                      gridTemplateColumns: gridTemplateWithOffBalance,
                      transform: `translateY(${virtualRow.start}px)`,
                    }}
                  >
                    <div className="p-1.5 flex flex-col justify-center border-r border-gray-100 dark:border-gray-800 bg-white dark:bg-gray-900">
                    ...
                    {showOffBalance && (
                      <div className="p-1 border-l border-gray-100 dark:border-gray-800 flex flex-col items-center justify-center bg-white dark:bg-gray-900">
