...
function SchedulePageContent() {
  ...
  const JOB_POLL_TIMEOUT_MS = 1000 * 60 * 20; // 20 minutes
  ...
  const buildAutoAdjustedPayload = (payload: GenerateScheduleInput, diagnostics: FailureDiagnostics | null) => {
    ...
    merged.constraintWeights = {
      ...
      dailyBalance: Math.max(0.3, merged.constraintWeights.dailyBalance * 0.7),
    };
    merged.dailyStaffingBalance = {
      ...merged.dailyStaffingBalance,
      weight: merged.constraintWeights.dailyBalance,
    };
